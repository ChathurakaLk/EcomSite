...
<nav id="header" class="top-0 z-30 w-full py-1">
    <div class="container flex flex-wrap items-center justify-between w-full px-6 py-3 mx-auto mt-0">
        ...
        <div class="order-3 hidden w-full md:flex md:items-center md:w-auto md:order-1" id="menu">
            <nav>
                <ul class="items-center justify-between pt-4 text-base text-gray-700 md:flex md:pt-0">
                    <li><a class="inline-block px-4 py-2 text-white border rounded-full cart-increment border-primary bg-primary hover:bg-transparent hover:text-black"
        ...
        <div class="flex items-center order-2 md:order-3" id="nav-content">
            ...
            <a class="inline-block p-1 text-white border rounded-full cart-increment border-primary bg-primary hover:bg-transparent hover:text-black"
                href="#">
            ...
            {{-- cartBtn --}}
            <a class="p-1 ml-3 text-white border rounded-full cart-increment border-primary bg-primary hover:bg-transparent hover:text-black"
                href="{{ route('Cart') }}">
                <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" viewBox="0 0 24 24">
                    <path
